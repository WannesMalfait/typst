...
/// [types]($float) [known]($str) [from]($array) [programming]($dict) languages,
/// Typst provides a special type for [_content._]($content) A value of this
...
impl Type {
    ...
    /// The type's normal name (e.g. `str`).
