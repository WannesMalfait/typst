...
| Dictionary               | `{(a: "hi", b: 2)}`           | [Dictionary]($dict)                |
...
| Function call            | `{min(x, y)}`                 | [Function]($func)                  |
| Argument spreading       | `{min(..nums)}`               | [Arguments]($args)                 |
| Unnamed function         | `{(x, y) => x + y}`           | [Function]($func)                  |
| Let binding              | `{let x = 1}`                 | [Scripting]($scripting/#bindings)  |
| Named function           | `{let f(x) = 2 * x}`          | [Function]($func)                  |
...
| Return from function     | `{return x}`                  | [Function]($func)                  |
